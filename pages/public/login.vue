	...
	<view class="container">
		...
		<view class="wrapper">
			...
			<view class=" flex flex-direction padding">
			  <view class="cu-modal" :class="modalName=='agreement'?'show':''">
			  	<view class="cu-dialog">
			  		...
			  		<view class="bg-white text-left padding text-sm">
			  			点击同意即表示您已阅读并同意
			  			<span class="text-blue" @tap="goNavigator(2)">《华雪用户注册协议》</span>
			  			与
			  			<span class="text-blue" @tap="goNavigator(1)">《华雪隐私政策》</span>
			  		</view>
			  ...
			  <button @click="getUserInfo" class="shouquan">授权获取个人信息</button>
			  </u-popup>
			</view>
			<!--  #endif -->
		</view>
		...
		data(){
			return {
				...
				nodes: [{
					...
					children: [{
						type: 'text',
						text: '在您注册成为华雪用户的过程中，您需要完成我们的注册流程并通过点击同意的形式在线签署以下协议，'
					}],
					},{
					name: 'span',
					attrs: {

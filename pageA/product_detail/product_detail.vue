<template>
	<view class="container">
		...
		<view class="wuliu">
			<view class="wuliu_center">
				<text class="wl_l">物流</text>
				<text class="wl_r">{{getList.logistics}}</text>
			</view>
		</view>
		<!-- 顶部 -->
		<view class="topAndCom">
			<view class="top">
				<view class="left">
					<!-- <text>企业门面</text> -->
					<image :src="getList.union_company.logo"></image>
				</view>
		<!-- 		<view class="right">
			...
			<view class="company">
				<view class="copmany_t">
					<view class="company_name">{{getList.union_company.title}}</view>
					<view class="company_phone">
						<text class="yticon icon-dianhua" style="color: white;" @click="makePhone(getList.union_company.mobile)"></text>
					</view>
				</view>
				<view class="copmany_b">
					<text class="yticon icon-icon--"></text>
					<text class="name">
						{{getList.union_company.contacts}}
					</text>
				</view>
				<view class="copmany_c">
					 ...
					 <text class="adds">{{getList.union_company.address}}</text>
				</view>
				<!-- 服务和动态 -->
		...
		<view class="page-bottom">
			<navigator url="/pages/index/index" open-type="switchTab" class="p-b-btn">
				<text class="yticon icon-shouye" @click="backhome"></text>
				<text>首页</text>
			</navigator>
			<view class="p-b-btn" :class="{ active: favorite }">
				<text class="yticon icon-wuliu" @click="wuliu"></text>
				<text>物流</text>
			</view>
			...
			<view class="action-btn-group" v-else>
				<button type="primary" class=" action-btn no-border buy-now-btn" open-type="contact">聊一聊</button>
				<button type="primary" class=" action-btn no-border add-cart-btn">打电话</button>
			</view>
		</view>

<template>
	...
	<!-- 	<view class="guidance-my" v-if="guidanceMy">
		...
		<!-- 分类筛选 -->
		<van-dropdown-menu>
		  <van-dropdown-item v-model="value1" :options="option1" @change="dropdownClick"/>
		  <van-dropdown-item v-model="value2" :options="option2" />
		   <van-dropdown-item v-model="value3" :options="option3" />
		</van-dropdown-menu>
		<!-- 企业列表 -->
		<qiyeInfoLlist :qiye="qiye"></qiyeInfoLlist>
		<tabbar></tabbar>
	</view>
</template>
...
import qiyeInfoLlist from '../../components/qiye_info_list.vue'
	export default {
			...
			return {
				...
				ctegory:[],
				   value1: 0,
					  ...
					  qiye:[
						  // {name:'赵丽颖有限公司',pic:require("../../static/guidance-3.png"),
						  // intro:'有临时仓,仓储托管等服务/60平方/小仓库出租出租出租出租出租',
						  // add:'广州八方六元点放松放松放松放松放松发大苏打水水',price:'15元 / 天 / 立方'},
						  // {name:'广州鹰路物流有限公司',pic:require("../../static/dianpu.png"),
						  // intro:'有临时仓,仓储托管等服务/60平方/小仓库出租出租出租出租出租',
						  // add:'广州八方六元点放松放松放松放松放松发大苏打水水',price:'15元 / 天 / 立方'},
						  // {name:'广州鹰路物流有限公司',pic:require("../../static/dianpu.png"),
						  // intro:'有临时仓,仓储托管等服务/60平方/小仓库出租出租出租出租出租',

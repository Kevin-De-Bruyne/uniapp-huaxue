...
if (process.env.NODE_ENV === "development") {
	if (NODE_ENV === 'test') {
		//测试环境
		// const domainName = 'http://dsshop.zhuemeng.com'
		const domainName = 'https://huaxue.juaiweb.com'
		// const domainName = 'https://hx.juaiweb.com'
		configURL = {
			lbsQq: '',
		...
		//生产环境
		const domainName = 'https://dsshop.test'
		configURL = {
			lbsQq: '',
			DomainName: domainName,
			BaseURL: domainName +INTERFACE,
